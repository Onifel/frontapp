    ...
    return (
        <div className='d-flex flex-column align-items-center connex'>
            ...
            <form action="">
                ...
                <div className='row mt-5 checkb'>
                    <div className='col-6 mt-5 custom-control custom-checkbox cnt'>
                        <label className='custom-control-label text-light-dark' for='check'> {""}
                            <input className='custom-control-input chb' type="checkbox" name="" id="check" />Restez connecté
                        </label>
                    </div>
